...
1. install AWSCLI
   ```sh
    ...
    #sudo apt install python-is-python3 - if no installation candidate
...
1. Validate your cluster
     ```sh
      #kops export kubecfg --admin (if reprovisioning a stopped instance or new certificate is required)
